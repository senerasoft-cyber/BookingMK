...
export default function AdminOverviewPage() {
  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-10">
      <h1 className="font-display text-xl font-semibold text-stone-900">Platform overview</h1>

      <div className="mt-6 grid gap-4 sm:grid-cols-3">
        <div className="rounded-xl border border-stone-200 p-4">
          <p className="text-sm text-stone-500">Total businesses</p>
          <p className="text-2xl font-semibold text-stone-900">{data.total_businesses}</p>
        </div>
        <div className="rounded-xl border border-stone-200 p-4">
        ...
        <div className="rounded-xl border border-stone-200 p-4">
          ...
          <p className="text-2xl font-semibold text-stone-900">€{data.mrr_eur}</p>
        </div>
      </div>

      <div className="mt-6 grid gap-4 sm:grid-cols-2">
        <div className="rounded-xl border border-stone-200 p-4">
          <p className="text-sm font-medium text-stone-700">By subscription status</p>
        ...
        <div className="rounded-xl border border-stone-200 p-4">
          <p className="text-sm font-medium text-stone-700">Active by plan</p>
          <ul className="mt-2 text-sm text-stone-600">
      ...
      <div className="mt-6 rounded-xl border border-stone-200 p-4">
        <p className="text-sm font-medium text-stone-700">Most recently registered</p>
