...
export default function TermsPage() {
  return (
    <LegalPageLayout title="Terms of Service" updated="2026-06-29">
      ...
      <h2 className="font-display text-lg font-semibold text-stone-900">1. The service</h2>
      <p>
      ...
      <h2 className="font-display text-lg font-semibold text-stone-900">2. Accounts</h2>
      <p>
      ...
      <h2 className="font-display text-lg font-semibold text-stone-900">4. Cancellation</h2>
      <p>
      ...
      <h2 className="font-display text-lg font-semibold text-stone-900">5. Acceptable use</h2>
      <p>
      ...
      <h2 className="font-display text-lg font-semibold text-stone-900">6. Your clients' data</h2>
      <p>
      ...
      <h2 className="font-display text-lg font-semibold text-stone-900">7. Service availability</h2>
      <p>
      ...
      <h2 className="font-display text-lg font-semibold text-stone-900">8. Changes</h2>
      <p>
        We may update these Terms from time to time. Continued use of Bukano after a change takes
        effect means you accept the updated Terms.
      </p>

      <h2 className="font-display text-lg font-semibold text-stone-900">9. Contact</h2>
      <p>
